...
├── publisher.go                # Dashboard update publication helpers
├── async_publisher.go          # Pending dashboard worker
...
- Dashboard publication path: `publisher.go`, `async_publisher.go`
