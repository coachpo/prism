...
func TestResolveRuntimeOperation(t *testing.T) {
	...
	unsupported := []struct {
		...
		{name: "openai image generations retired", method: http.MethodPost, path: "/v1/images/generations"},
		{name: "openai image edits retired", method: http.MethodPost, path: "/v1/images/edits"},
