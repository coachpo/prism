...
func TestResolveRuntimeOperation(t *testing.T) {
	...
	unsupported := []struct {
		...
		{name: "image generations trailing slash", method: http.MethodPost, path: "/v1/images/generations/"},
		{name: "image edits trailing slash", method: http.MethodPost, path: "/v1/images/edits/"},
		{name: "image variations unsupported", method: http.MethodPost, path: "/v1/images/variations"},
