...
func TestPromotionObservabilityPreservesTranslationAttrs(t *testing.T) {
	...
	assertRuntimeContextOverflowPromotionDecision(t, finalRequestLog.ContextRouting.ContextOverflowPromotion, 400, "context_length_exceeded", cliProxyAPIOverflowClassifierErrorCode, runtimeContextOverflowPromotionTriggerPhaseProviderOverflow, runtimeContextOverflowPromotionEstimationModeEstimated, openAIResponsesContextEstimationMethod, 700, 1024, 1724, sourceResolvedTargetModelID, 101, promotedResolvedTargetModelID, 202, 180000, 360000, 1, 2, runtimeContextOverflowPromotionResultPromotedSuccess)
