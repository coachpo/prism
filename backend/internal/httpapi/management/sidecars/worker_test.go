...
func TestPrivacyWatchdogWorkerSummaryLogsDistinguishProbeOutcomes(t *testing.T) {
	...
	upstream.setAuthFile("auth-summary-restored", "idx-summary-restored", "codex", DefaultQuotaExceededPriority)
	upstream.setAuthFile("auth-summary-failed", "idx-summary-failed", "codex", DefaultQuotaExceededPriority)
