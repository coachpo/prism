...
## OVERVIEW
`management/configrules/` owns Default-profile configuration rules under `/api/config/*`. It manages header-blocklist rules and user-agent/client mapping rules used by management and runtime-adjacent helpers.
