...
func selectedRouteReason(attempts []gatewaycore.RouteAttempt) gatewaycore.RouteReason {
	...
	for _, attempt := range attempts {
		...
		case gatewaycore.RouteReasonQPSOverflow, gatewaycore.RouteReasonRPMOverflow, gatewaycore.RouteReasonTPMOverflow, gatewaycore.RouteReasonIPMOverflow, gatewaycore.RouteReasonConcurrencyOverflow, gatewaycore.RouteReasonRetry429, gatewaycore.RouteReasonRetry5xx, gatewaycore.RouteReasonRetryHTTP, gatewaycore.RouteReasonRetryConnectTimeout, gatewaycore.RouteReasonRetryTransport, gatewaycore.RouteReasonRerouteHTTP:
...
func canonicalRouteReason(reason gatewaycore.RouteReason) gatewaycore.RouteReason {
	switch reason {
	case gatewaycore.RouteReasonDirectMatch, gatewaycore.RouteReasonModelRedirect, gatewaycore.RouteReasonUpstreamRedirect, gatewaycore.RouteReasonQPSOverflow, gatewaycore.RouteReasonRPMOverflow, gatewaycore.RouteReasonTPMOverflow, gatewaycore.RouteReasonIPMOverflow, gatewaycore.RouteReasonConcurrencyOverflow, gatewaycore.RouteReasonRetry429, gatewaycore.RouteReasonRetry5xx, gatewaycore.RouteReasonRetryHTTP, gatewaycore.RouteReasonRetryConnectTimeout, gatewaycore.RouteReasonRetryTransport, gatewaycore.RouteReasonRerouteHTTP, gatewaycore.RouteReasonCircuitOpenSkip, gatewaycore.RouteReasonNoHealthyUpstream, gatewaycore.RouteReasonPolicyReject:
		return reason
	default:
		return gatewaycore.RouteReasonPolicyReject
	}
