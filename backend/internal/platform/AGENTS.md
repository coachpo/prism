...
- Keep listener, database URL, pool budgets, runtime side-effect attempt timeout, runtime secret encryption key, and JWT signing key restart-required. `runtime.sideEffects.attemptTimeout` stays restart-required and is not hot-applied.
