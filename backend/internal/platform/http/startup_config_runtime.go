...
func buildStartupConfigRuntimeSnapshot(settings config.Settings) (*startupConfigRuntimeSnapshot, error) {
	return &startupConfigRuntimeSnapshot{
		...
		runtimeProxy: buildStartupRuntimeProxySnapshot(settings),
...
func buildStartupRuntimeProxySnapshot(settings config.Settings) StartupRuntimeProxySnapshot {
...
func (s StartupRuntimeProxySnapshot) TransportConfig() config.RuntimeTransportConfig {
