...
var managementRouteSpecs = []managementRouteSpec{
	...
	{name: "model routing diagnostics preview", method: http.MethodPost, pattern: "/models/{model_config_id}/routing-diagnostics/preview", tier: priority.ManagementTierM2},
