...
var managementRouteSpecs = []managementRouteSpec{
	...
	{name: "sidecar auth snapshot read", method: http.MethodGet, pattern: "/sidecars/{sidecar_id}/auth-snapshots/{snapshot_id}", tier: priority.ManagementTierM3},
	...
	{name: "sidecar watchdog policy read", method: http.MethodGet, pattern: "/sidecars/{sidecar_id}/watchdog-policy", tier: priority.ManagementTierM2},
	{name: "sidecar watchdog policy update", method: http.MethodPut, pattern: "/sidecars/{sidecar_id}/watchdog-policy", tier: priority.ManagementTierM2},
	{name: "sidecar action history list", method: http.MethodGet, pattern: "/sidecars/{sidecar_id}/actions", tier: priority.ManagementTierM3},
