...
var managementRouteSpecs = []managementRouteSpec{
	...
	{name: "audit logs delete", method: http.MethodDelete, pattern: "/audit/logs", tier: priority.ManagementTierM3},
	...
	{name: "loadbalance events delete", method: http.MethodDelete, pattern: "/loadbalance/events", tier: priority.ManagementTierM3},
	...
	{name: "settings retention read", method: http.MethodGet, pattern: "/settings/retention", tier: priority.ManagementTierM2},
	{name: "settings retention write", method: http.MethodPut, pattern: "/settings/retention", tier: priority.ManagementTierM2},
	...
	{name: "stats requests delete", method: http.MethodDelete, pattern: "/stats/requests", tier: priority.ManagementTierM3},
	...
	{name: "stats statistics delete", method: http.MethodDelete, pattern: "/stats/statistics", tier: priority.ManagementTierM3},
