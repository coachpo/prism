...
var managementRouteSpecs = []managementRouteSpec{
	...
	{name: "model exports source", method: http.MethodGet, pattern: "/models/exports/{platform}/source", tier: priority.ManagementTierM3, profileScoped: true, cache: runtimeCacheEffect{}, notes: "Default-profile client model-config export source snapshot; read-only, never invalidates planning."},
	{name: "model exports render", method: http.MethodPost, pattern: "/models/exports/{platform}/render", tier: priority.ManagementTierM3, profileScoped: true, cache: runtimeCacheEffect{none: true}, notes: "Deterministic Pi/OpenCode client file render; digest-guarded replay with no network or planning effects."},
