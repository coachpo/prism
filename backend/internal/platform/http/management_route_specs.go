...
var managementRouteSpecs = []managementRouteSpec{
	{name: "model route explanation", method: http.MethodGet, pattern: "/models/{model_config_id}/route-explanation", tier: priority.ManagementTierM1, profileScoped: true, privateNoStore: true, cache: runtimeCacheEffect{}},
	...
	{name: "batch model_limits preview", method: http.MethodPost, pattern: "/models/batch/model_limits/preview", tier: priority.ManagementTierM2, profileScoped: true, privateNoStore: true, cache: runtimeCacheEffect{none: true}, notes: "Bounded atomic maintenance with frozen preview CAS."},
	{name: "batch model_limits apply", method: http.MethodPost, pattern: "/models/batch/model_limits/apply", tier: priority.ManagementTierM2, profileScoped: true, privateNoStore: true, cache: runtimeCacheEffect{none: true}, notes: "Bounded atomic maintenance with frozen preview CAS."},
	{name: "batch model_strategy preview", method: http.MethodPost, pattern: "/models/batch/model_strategy/preview", tier: priority.ManagementTierM2, profileScoped: true, privateNoStore: true, cache: runtimeCacheEffect{none: true}, notes: "Bounded atomic maintenance with frozen preview CAS."},
	{name: "batch model_strategy apply", method: http.MethodPost, pattern: "/models/batch/model_strategy/apply", tier: priority.ManagementTierM2, profileScoped: true, privateNoStore: true, cache: runtimeCacheEffect{planning: true, routeWitness: true}, notes: "Bounded atomic maintenance with frozen preview CAS."},
	{name: "batch target_pricing preview", method: http.MethodPost, pattern: "/models/batch/target_pricing/preview", tier: priority.ManagementTierM2, profileScoped: true, privateNoStore: true, cache: runtimeCacheEffect{none: true}, notes: "Bounded atomic maintenance with frozen preview CAS."},
	{name: "batch target_pricing apply", method: http.MethodPost, pattern: "/models/batch/target_pricing/apply", tier: priority.ManagementTierM2, profileScoped: true, privateNoStore: true, cache: runtimeCacheEffect{planning: true}, notes: "Bounded atomic maintenance with frozen preview CAS."},
	...
	{name: "model export source", method: http.MethodGet, pattern: "/models/exports/pi/source", tier: priority.ManagementTierM3, profileScoped: true, privateNoStore: true, cache: runtimeCacheEffect{}, notes: "Default-profile Pi client model-config export source snapshot for direct-entry models only; read-only, never invalidates planning."},
	...
	{name: "OpenCode model export source", method: http.MethodGet, pattern: "/models/exports/opencode/source", tier: priority.ManagementTierM3, profileScoped: true, privateNoStore: true, cache: runtimeCacheEffect{}, notes: "Default-profile OpenCode client export snapshot of direct-entry models and persisted models.dev metadata; no network or planning effects."},
	{name: "OpenCode model export render", method: http.MethodPost, pattern: "/models/exports/opencode/render", tier: priority.ManagementTierM3, profileScoped: true, privateNoStore: true, cache: runtimeCacheEffect{none: true}, notes: "Deterministic OpenCode client file render from a digest-guarded read-only snapshot; no network or planning effects."},
	...
	{name: "model read", method: http.MethodGet, pattern: "/models/{model_config_id}", tier: priority.ManagementTierM2, profileScoped: true, privateNoStore: true, cache: runtimeCacheEffect{}, notes: "Model reads include the direct_request_enabled entry bit and incoming Model Target warning; model updates and deletes refresh planning. The response embeds models.dev binding evidence while that legacy field remains, so it stays private and non-cacheable."},
	...
	{name: "model update", method: http.MethodPut, pattern: "/models/{model_config_id}", tier: priority.ManagementTierM2, profileScoped: true, cache: runtimeCacheEffect{planning: true, routeWitness: true}, notes: "Model reads are scoped; direct_request_enabled updates and other model changes refresh planning and route-witness snapshots."},
	...
	{name: "models list", method: http.MethodGet, pattern: "/models", tier: priority.ManagementTierM2, profileScoped: true, cache: runtimeCacheEffect{}, notes: "Default-profile full model inventory read; each row projects direct_request_enabled, incoming Model Target count, and structured warnings."},
