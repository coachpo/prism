...
var managementRouteSpecs = []managementRouteSpec{
	...
	{name: "model catalog read", method: http.MethodGet, pattern: "/models/{model_config_id}/catalog", tier: priority.ManagementTierM2, profileScoped: true, cache: runtimeCacheEffect{}, notes: "Default-profile models.dev binding read; metadata never enters the runtime snapshot."},
	{name: "model catalog candidates read", method: http.MethodGet, pattern: "/models/{model_config_id}/catalog/candidates", tier: priority.ManagementTierM2, profileScoped: true, cache: runtimeCacheEffect{}, notes: "Bounded catalog candidate search for manual binding."},
	{name: "model catalog match preview", method: http.MethodPost, pattern: "/models/{model_config_id}/catalog/match-preview", tier: priority.ManagementTierM2, profileScoped: true, cache: runtimeCacheEffect{none: true}, notes: "Read-only unique-match preview; remote I/O stays outside transactions and never invalidates planning."},
	{name: "model catalog bind", method: http.MethodPost, pattern: "/models/{model_config_id}/catalog/bind", tier: priority.ManagementTierM2, profileScoped: true, cache: runtimeCacheEffect{none: true}, notes: "Catalog metadata bind/refresh only; never invalidates planning."},
	{name: "model catalog refresh preview", method: http.MethodPost, pattern: "/models/{model_config_id}/catalog/refresh/preview", tier: priority.ManagementTierM2, profileScoped: true, cache: runtimeCacheEffect{none: true}, notes: "Read-only source diff preview against the fetched catalog revision."},
	{name: "model catalog refresh commit", method: http.MethodPost, pattern: "/models/{model_config_id}/catalog/refresh/commit", tier: priority.ManagementTierM2, profileScoped: true, cache: runtimeCacheEffect{none: true}, notes: "Replaces source_values only after the revision guard; manual overrides survive and planning is untouched."},
	{name: "model catalog override write", method: http.MethodPut, pattern: "/models/{model_config_id}/catalog/override", tier: priority.ManagementTierM2, profileScoped: true, cache: runtimeCacheEffect{none: true}, notes: "Per-field manual override authoring; management-only metadata."},
	{name: "model catalog override clear", method: http.MethodDelete, pattern: "/models/{model_config_id}/catalog/override", tier: priority.ManagementTierM2, profileScoped: true, cache: runtimeCacheEffect{none: true}, notes: "Bulk per-field restore to source values."},
	{name: "model catalog unbind", method: http.MethodDelete, pattern: "/models/{model_config_id}/catalog", tier: priority.ManagementTierM2, profileScoped: true, cache: runtimeCacheEffect{none: true}, notes: "Drops the models.dev binding row; model runtime identity is unchanged."},
	...
	{name: "pricing template catalog preview", method: http.MethodPost, pattern: "/pricing-templates/catalog/preview", tier: priority.ManagementTierM2, profileScoped: true, cache: runtimeCacheEffect{none: true}, notes: "Read-only source-linked price plan preview; remote I/O stays outside transactions."},
	{name: "pricing template catalog commit", method: http.MethodPost, pattern: "/pricing-templates/catalog/commit", tier: priority.ManagementTierM2, profileScoped: true, cache: runtimeCacheEffect{planning: true}, notes: "Atomic source-linked template import/revision plus Terminal Target assignment; wakes planning after commit."},
	...
	{name: "model export source", method: http.MethodGet, pattern: "/models/export/source", tier: priority.ManagementTierM3, profileScoped: true, cache: runtimeCacheEffect{}, notes: "Default-profile Pi client model-config export source snapshot; read-only, never invalidates planning."},
	{name: "model export render", method: http.MethodPost, pattern: "/models/export/render", tier: priority.ManagementTierM3, profileScoped: true, cache: runtimeCacheEffect{none: true}, notes: "Deterministic Pi client file render; digest-guarded replay with no network I/O and no planning effects."},
	{name: "model pi bind", method: http.MethodPost, pattern: "/models/{model_config_id}/pi/bind", tier: priority.ManagementTierM2, profileScoped: true, cache: runtimeCacheEffect{none: true}, notes: "Freezes a pi.dev candidate coordinate into model_pi_catalog_bindings; never invalidates planning."},
	{name: "model pi refresh preview", method: http.MethodPost, pattern: "/models/{model_config_id}/pi/refresh/preview", tier: priority.ManagementTierM2, profileScoped: true, cache: runtimeCacheEffect{none: true}, notes: "Read-only source diff preview against the fetched pi.dev catalog revision."},
	{name: "model pi refresh commit", method: http.MethodPost, pattern: "/models/{model_config_id}/pi/refresh/commit", tier: priority.ManagementTierM2, profileScoped: true, cache: runtimeCacheEffect{none: true}, notes: "Replaces the binding's source fields only after the revision guard; manual overrides survive and planning is untouched."},
	{name: "model pi override write", method: http.MethodPut, pattern: "/models/{model_config_id}/pi/override", tier: priority.ManagementTierM2, profileScoped: true, cache: runtimeCacheEffect{none: true}, notes: "Per-field manual override authoring on the seven safe pi.dev leaves; management-only metadata."},
	{name: "model pi override clear", method: http.MethodDelete, pattern: "/models/{model_config_id}/pi/override", tier: priority.ManagementTierM2, profileScoped: true, cache: runtimeCacheEffect{none: true}, notes: "Bulk per-field restore to the bound source values."},
	{name: "model pi unbind", method: http.MethodDelete, pattern: "/models/{model_config_id}/pi", tier: priority.ManagementTierM2, profileScoped: true, cache: runtimeCacheEffect{none: true}, notes: "Drops the model_pi_catalog_bindings row; model runtime identity is unchanged."},
	...
	{name: "model read", method: http.MethodGet, pattern: "/models/{model_config_id}", tier: priority.ManagementTierM2, profileScoped: true, cache: runtimeCacheEffect{}, notes: "Model reads are scoped; model updates and deletes refresh planning."},
