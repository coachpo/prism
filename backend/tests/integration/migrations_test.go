...
func TestProxyKeyImmutableAttributionUpgradePath(t *testing.T) {
	...
	// Simulate a pre-000005 database: roll back 000005/000006 schema surface
	// and re-stamp history at 000004 so the upgrade path re-applies them.
	for _, version := range []string{"000006_proxy_api_key_immutable_attribution_finalize", "000005_proxy_api_key_immutable_attribution"} {
