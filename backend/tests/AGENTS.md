...
- Runtime coverage for profile scoping, realtime delivery, request-log contracts, published runtime snapshots, cache-generation invalidation, telemetry outboxes, and related runtime persistence semantics.
...
- Runtime packages for profile scope, realtime delivery, request-log contracts, cache invalidation, runtime snapshots, and telemetry outboxes: `runtime/profile_scope_test.go`, `runtime/realtime_test.go`, `runtime/request_logs_contract_test.go`, `runtime/runtime_cache_invalidation_test.go`, `runtime/runtime_phase1_snapshot_test.go`, `runtime/runtime_telemetry_outbox_test.go`
