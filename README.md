...
> **Status**: active development at v1.0.18 — self-hosted on a home LAN, no external users, PostgreSQL-backed, with development and deployment convenience prioritized over data-security hardening. See [STATUS.md](STATUS.md) for the authoritative lifecycle, deployment, and compatibility facts.
