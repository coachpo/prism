...
const staticMessagesStub = {
  getStaticMessages: () => ({
    modelDetailData: {
      ...
      saveConnectionFailed: "saveConnectionFailed",
    },
    modelsData: {
      contextWindowTokensInvalid: "contextWindowTokensInvalid",
      defaultOutputTokenReserveInvalid: "defaultOutputTokenReserveInvalid",
      maxContextUtilizationInvalid: "maxContextUtilizationInvalid",
      preferredContextUtilizationThresholdInvalid: "preferredContextUtilizationThresholdInvalid",
      preferredContextUtilizationThresholdExceedsMaxContextUtilization:
        "Preferred context utilization threshold must be less than or equal to max context utilization.",
    },
  }),
};
...
test("edit hydration preserves same-as-owner explicit override intent from raw metadata", () => {
  ...
  assert.deepEqual(hydratedForm.context_capability_drafts.preferred_context_utilization_threshold, {
    mode: "override",
    value: "0.7",
  });
});
