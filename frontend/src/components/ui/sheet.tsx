  ...
  return (
    <>
      ...
      >
        {children}
        {showCloseButton && (
          <SheetPrimitive.Close className="data-[state=open]:bg-secondary absolute top-4 right-4 rounded-md opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none">
