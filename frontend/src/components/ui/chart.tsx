...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "grid min-w-[8.5rem] items-start gap-2 rounded-xl border border-(--chart-tooltip-border) bg-(--chart-tooltip-background) px-3 py-2 text-xs shadow-md backdrop-blur-sm",
        className
      )}
    >
