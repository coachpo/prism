...
function session(overrides: Partial<GeneratedProxyKeySession> = {}): GeneratedProxyKeySession {
  return {
    source: "create",
    keyId: 42,
    itemSnapshot: { id: 42, name: "prod", key_prefix: "pm-1a2b", key_preview: "pm-1a2b••••••••9f3e", is_active: true, expires_at: null, last_used_at: null, last_used_ip: null, notes: null, rotated_at: null, rotation_count: 0, created_at: "2026-08-09T00:00:00Z", updated_at: "2026-08-09T00:00:00Z" },
