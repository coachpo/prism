...
describe("Endpoint direct-reference contract", () => {
  ...
  it("fails closed when the references batch returns 503: no fake zero, no delete confirm", async () => {
    ...
    await waitFor(() => {
      expect(screen.getAllByText("引用信息加载失败").length).toBeGreaterThan(0)
    })
        ...
        items: [
          {
            ...
            owner_model: { id: 7, model_id: "gpt-example", display_name: "Example", is_enabled: true, openai_accepted_format: "dual_native" },
