...
- Active feature-route ownership and leaves: `../features/AGENTS.md`, `../features/settings/startup/AGENTS.md`, `../features/sidecars/AGENTS.md`
...
- Keep global routes such as `/control/sidecars` and `/control/proxy-keys` separate from selected-profile route state. Treat `/system/settings` as a mixed shell where Profile-tab sections are selected-profile scoped while Global and Startup surfaces are instance scoped.
