...
function UserAgentClientRuleSection({
  ...
  return (
    <Collapsible open={open} onOpenChange={onOpenChange}>
      <CollapsibleTrigger className="flex w-full items-center gap-2 rounded-md px-2 py-1.5 text-sm font-medium transition-colors hover:bg-inset">
              ...
              <TableBody>
                {rules.map((rule) => (
                  <TableRow key={rule.id}>
                    ...
                    <TableCell>
                      <code className="rounded bg-inset px-[0.3rem] py-[0.2rem] font-mono text-sm">
                        {rule.pattern}
                      </code>
                    </TableCell>
