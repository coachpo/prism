...
- Billing and currency section shell that renders the reporting-currency card and the currency-migration dialog, while staying separate from costing state: `BillingCurrencySection.tsx`, `billing-currency/AGENTS.md`
...
- `billing-currency/`: `ReportingCurrencyCard.tsx` and `CurrencyMigrationDialog.tsx`; its leaf doc lives at `billing-currency/AGENTS.md`
