import type { AuditLogDetail, RequestLogDetailRouting } from "@/lib/types";

type AuditCaptureProvenance =
  | Pick<RequestLogDetailRouting, "audit_enabled_at_request" | "audit_capture_bodies_at_request">
