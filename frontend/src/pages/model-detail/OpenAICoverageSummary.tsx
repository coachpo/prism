...
function groupStatusLabel(status: string | undefined): { label: string; intent: OperatorBadgeIntent } {
  switch (status) {
    case "routable":
      return { label: "routable", intent: "healthy" }
    case "compatible_but_ineligible":
      return { label: "compatible_but_ineligible", intent: "degraded" }
    case "uncovered":
      return { label: "uncovered", intent: "failing" }
    default:
      return { label: "not_accepted", intent: "idle" }
  }
}
