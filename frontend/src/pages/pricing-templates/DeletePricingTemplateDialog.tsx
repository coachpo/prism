...
import { OperatorCallout, OperatorDestructiveDialog, OperatorInsetPanel } from "@/shared/design-system";
...
export function DeletePricingTemplateDialog({
  ...
  return (
    <OperatorDestructiveDialog
      ...
      description={copy.deletePricingTemplateDescription(dialogTemplate?.name ?? "")}
