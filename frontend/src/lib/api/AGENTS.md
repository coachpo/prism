...
- Global profile/vendor management plus profile-scoped model, access-target, loadbalance strategy, endpoint, read-only connection/reference, owner-scoped model connection, and pricing-template surfaces: `management.ts`
