...
export const enMessages: Messages = {
  ...
  settingsPage: {
    ...
    globalTab: "Global",
    profileScopedSettings: "Default-profile settings",
    profileTab: "Default profile",
    retentionDeletion: "Retention & Deletion",
    selectedProfileFallback: "Default profile",
    sectionsTitle: "Settings Sections",
    settingsDescription: "Manage instance-wide authentication and Default-profile configuration",
  ...
  endpointsPage: {
    ...
    description: "Manage Default-profile API credentials and endpoint routing targets.",
  ...
  modelsUi: {
    ...
    save: "Save",
    selectSameFamilyModel: "Select target model",
