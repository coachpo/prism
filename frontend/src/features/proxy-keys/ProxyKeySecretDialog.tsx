          ...
          <DialogBody className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              {modelsLoading ? (
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <Button type="button" variant="outline" size="sm" className="w-fit" onClick={() => window.location.reload()}>
                    {copy.retry}
                  </Button>
                </div>
              ) : candidates.length === 0 ? (
            ...
            {curl ? (
              <div className="flex flex-col gap-2">
                ...
                <pre className="overflow-x-auto rounded-md border border-outline-variant bg-surface-container-low p-3 text-[11px] leading-relaxed">
                  <code>{curl.curl}</code>
                </pre>
              </div>
            ) : (
      ...
      {state.kind === "closing_confirm" ? (
        <Dialog open>
          <DialogContent className="sm:max-w-md" showCloseButton={false}>
            ...
            <DialogBody>
              <p className="text-sm text-muted-foreground">{copy.newSecretCloseDetail}</p>
            </DialogBody>
            <DialogFooter>
