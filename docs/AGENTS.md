...
- OpenAI native wire compatibility and historical translation-mode reads: `../backend/internal/httpapi/runtime/operation_translation.go`, `../backend/internal/providerauth/providerauth.go`, `../backend/internal/domain/stats/request_logs.go`
