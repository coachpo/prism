...
- Model create/edit labels this public identity as “入口模型 ID”. Renaming it changes client lookup only and never rewrites an existing Terminal Target's upstream identity
